...
select to_number(to_char(a.ngay_sd, 'yyyymm')) thang, a.ma_tb, a.ten_tb
                        ...
                        where a.loaitb_id = 61 --and a.trangthaitb_id in (5,6,7,9)
                                        and b.chuquan_id = 145 and ((to_number(to_char(a.ngay_cat, 'yyyymm'))  =202411 and a.trangthaitb_id in (7, 9)) or (to_number(to_char(a.ngay_td, 'yyyymm')) =202411 and a.trangthaitb_id in (5,6)))