...
where thang = 202501 and ma_kpi like '%_060' and ma_vtcv in ('VNP-HNHCM_BHKV_15','VNP-HNHCM_BHKV_17')
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);
-- pdg
    update ttkd_bsc.bangluong_kpi x
set TYTRONG= 20, CHITIEU_GIAO = 50
where thang = 202501 and ma_kpi like '%_060' and ma_vtcv in ('VNP-HNHCM_BHKV_2')
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);
--gd
        update ttkd_bsc.bangluong_kpi x
set TYTRONG= 20, CHITIEU_GIAO = 50
where thang = 202501 and ma_kpi like '%_060' and ma_vtcv in ('VNP-HNHCM_BHKV_1')
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);

--update 012
-- --PDG
update ttkd_bsc.bangluong_kpi x
set TYTRONG= 45, chitieu_giao = 100 ,GIAO = 5084.52199, DONVI_TINH ='Triệu đồng'
where thang = 202501 and ma_kpi like '%HCM_DT_VNPTT_012' and ma_vtcv ='VNP-HNHCM_KDOL_2'
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);
--TruongCa 012
    update ttkd_bsc.bangluong_kpi x
set TYTRONG= 50, chitieu_giao = 100 ,GIAO = 5084.52199, DONVI_TINH ='Triệu đồng'
where thang = 202501 and ma_kpi like '%HCM_DT_VNPTT_012' and ma_vtcv ='VNP-HNHCM_KDOL_17.1'
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);

--update 009
update ttkd_bsc.bangluong_kpi x
set TYTRONG= 50,chitieu_giao = null ,GIAO = 270
where thang = 202501 and ma_kpi like '%HCM_DT_VNPTT_009'
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);

--update giao 010 BHOL
update ttkd_bsc.bangluong_kpi x
set TYTRONG= 20, chitieu_giao = null ,GIAO = 1.5
where thang = 202501 and ma_kpi like '%HCM_DT_VNPTT_010'
and exists (select 1 from ttkd_bsc.nhanvien a where thang = 202501 and tinh_bsc = 1 and x.ma_nv =a.ma_nv);
...
--update tu bang tong hop KPI _060
    ...
    where x.thang = 202501 and x.ma_kpi like '%_060' and x.ma_vtcv in ('VNP-HNHCM_BHKV_15','VNP-HNHCM_BHKV_17','VNP-HNHCM_BHKV_2','VNP-HNHCM_BHKV_1')
...
delete from BSC_TONGHOP where ma_kpi like '%_060' and thang = 202501;
...
with rawdata as (
   ...
   from va_ct_BSC_DTHU_DTRI_NAM
    where thang = 202501-- and manv_ptm ='VNP020754'
...
on a.ma_to = b.ma_to 
and b.thang = 202501 and b.ma_vtcv ='VNP-HNHCM_BHKV_17'
union all
    ...
    left join 
            (select * from ttkd_Bsc.blkpi_dm_to_pgd x where thang = 202501 and x.ma_kpi =  'HCM_DT_PTMOI_060'
