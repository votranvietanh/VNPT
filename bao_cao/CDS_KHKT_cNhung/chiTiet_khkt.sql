...
--            , (d.LOAIHINH_TB)                                     loai_hinh_thue_bao
     ...
     select * from ttkd_bsc.ct_bsc_ptm where ma_tb = 'hcm_hddt_00010596' and thang_ptm = 202410;





----E trao đổi với @quanhoo bs cột thông tin còn thiếu giúp chị: trạng thái thanh toán, tỷ lệ CK, số lượng HĐĐT, HS gốc nhé. Thanks.
select *
from (select MA_TB                                               ma_thue_bao
--            , (d.LOAIHINH_TB)                                     loai_hinh_thue_bao
           , (select d.LOAIHINH_TB from css_hcm.loaihinh_tb d where d.LOAITB_ID = a.LOAITB_ID)  LOAIHINH_TB
     ...
     select * from KHKT_BC_HOAHONG_2 where thang_ptm = 202411;
     select * from css.v_ct_mua_tbi@dataguard where hdtb_id = 27805889;